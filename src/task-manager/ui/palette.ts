...
const HUES = [
  { light: "bg-blue-100 text-blue-800", solid: "bg-blue-600" },
  { light: "bg-emerald-100 text-emerald-800", solid: "bg-emerald-600" },
  { light: "bg-amber-100 text-amber-800", solid: "bg-amber-600" },
  { light: "bg-rose-100 text-rose-800", solid: "bg-rose-600" },
  { light: "bg-violet-100 text-violet-800", solid: "bg-violet-600" },
  { light: "bg-cyan-100 text-cyan-800", solid: "bg-cyan-600" },
  { light: "bg-orange-100 text-orange-800", solid: "bg-orange-600" },
  { light: "bg-lime-100 text-lime-800", solid: "bg-lime-600" },
  { light: "bg-pink-100 text-pink-800", solid: "bg-pink-600" },
  { light: "bg-teal-100 text-teal-800", solid: "bg-teal-600" },
] as const;
