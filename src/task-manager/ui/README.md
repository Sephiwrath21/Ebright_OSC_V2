...
| Superadmin (ADMIN) | same as CEO | Department\|Branch toggle → dropdown → selected entity's full Daily + Monthly + HOD Assigned card grid (`EntityCardOverview`, 2026-08-12) · "+ Task" in the page header — the org grids (all-departments · Branch by Region · Ad hoc by Region) that used to render on the OSC Home page were removed entirely, 2026-08-15; this page's dropdown overview is now the only place to see this data |
