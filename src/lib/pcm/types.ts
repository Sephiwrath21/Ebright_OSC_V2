...
export interface Invitation {
  ...
  /** Google Drive link to the coach's photo proof that the parent turned up —
   *  typically a screenshot of the coach thanking them for coming. Uploadable
   *  only once status = attended, for renewal and progress alike; cleared when
   *  the student stops being marked present. */
