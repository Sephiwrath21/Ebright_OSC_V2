...
export type CardFieldKey =
  ...
  | 'qaqc'              // QAQC verification tick (only Super/Regional/Operation).
  // Contact details
  | 'email'             // Contact email.
  | 'phone'             // Contact phone.
...
export const DEFAULT_CARD_PREFS: CardPrefs = {
  ...
  fields: ['name', 'parentName', 'ageCategory', 'leadSource', 'lastStageChange', 'owner', 'stageBadge', 'createdAt', 'qaqc'],
...
export const ALL_CARD_FIELDS: Array<{
  ...
  { key: 'qaqc',            label: 'QAQC Verified',       group: 'core' },
