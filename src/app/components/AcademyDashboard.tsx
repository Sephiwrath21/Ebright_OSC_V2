          ...
          <div className="lg:col-span-7 space-y-6">
            ...
            <div className="bg-white border border-slate-200 rounded-2xl p-6 shadow-sm dark:bg-slate-900 dark:border-slate-800">
              <div className="flex items-center justify-between mb-4">
                ...
                <span className="text-[9px] font-bold text-slate-400 bg-slate-100 border border-slate-200 px-2 py-0.5 rounded uppercase tracking-wide font-mono dark:bg-slate-800 dark:border-slate-700">
                  Database Active
                </span>
              </div>
                      ...
                      <div className="space-y-2">
                        <div className="flex items-center gap-2">
                          ...
                          <span className={`px-2 py-0.5 rounded text-[9px] font-bold border uppercase tracking-wider ${
                            student.active
                              ? "bg-emerald-50 text-emerald-600 border-emerald-100 dark:bg-emerald-900 dark:text-emerald-300 dark:border-emerald-700"
                        ...
                        <div className="flex flex-wrap gap-4 text-slate-500 dark:text-slate-400">
                          ...
                          <span className="flex items-center gap-1 text-slate-600 font-medium dark:text-slate-300">
