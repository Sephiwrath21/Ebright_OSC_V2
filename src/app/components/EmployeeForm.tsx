          ...
          >
                  ...
                  <div className="relative w-32">
                    <select
                      ...
                      className={`${inputCls} pr-8 appearance-none cursor-pointer font-mono ${
                        ddLocked ? "bg-slate-50 dark:bg-slate-800 text-slate-600 dark:text-slate-300 cursor-not-allowed" : ""
                      }`}
                    >
            ...
            {isNoOrgRole && (
              <Field label="Department">
                <div className={`${inputCls} flex items-center bg-slate-50 dark:bg-slate-800 text-slate-500 dark:text-slate-400`}>
