    ...
    <div className="bg-white rounded-2xl border border-slate-200 shadow-sm flex flex-col overflow-hidden hover:shadow-md transition-shadow">
      ...
      <div className="flex items-start justify-between px-5 pt-5 pb-4">
        <div className="flex items-start gap-3">
          ...
          <div>
            <p className="text-sm font-semibold text-slate-900 leading-snug">{intg.label}</p>
            <div className="mt-1">
      ...
      {/* Description */}
      <p className="px-5 text-xs text-slate-500 leading-relaxed flex-1">{intg.description}</p>
      ...
      {intg.webhookUrl && status === "CONNECTED" && (
        <div className="px-5 mt-3">
          ...
          <div className="flex items-center gap-1.5 rounded-lg bg-slate-50 border border-slate-200 px-3 py-1.5">
            <code className="flex-1 text-[10px] text-slate-600 truncate">{intg.webhookUrl}</code>
            <button
              onClick={copyWebhook}
      ...
      <div className="w-full mx-auto px-4 sm:px-6 lg:px-8 pt-4 pb-10">
        ...
        <div className="mb-6">
          <div className="flex items-start justify-between">
            ...
            <span className="inline-flex items-center gap-1.5 rounded-xl bg-emerald-50 border border-emerald-200 px-3 py-1.5 text-xs font-semibold text-emerald-700">
