...
export default function FlowghanEmbed() {
  return (
    <div className="flex h-full flex-1 min-h-0 flex-col bg-slate-50">
      <div className="flex items-center h-12 px-4 border-b border-slate-200 bg-white shrink-0">
        <Link
          href="/home"
          className="flex items-center gap-1.5 rounded-lg px-2.5 py-1.5 text-sm font-medium text-slate-600 hover:bg-slate-100 hover:text-slate-900 transition-colors focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-blue-500"
        >
