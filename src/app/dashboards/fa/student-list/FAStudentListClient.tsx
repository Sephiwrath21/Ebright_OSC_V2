  ...
  return (
    <div className="min-h-full bg-slate-50 dark:bg-slate-950">
      <div className="w-full mx-auto px-4 sm:px-6 lg:px-8 pt-6 pb-10">
        ...
        {/* Masthead */}
        <div className="mb-6">
          <div className="text-[10px] font-mono uppercase tracking-widest text-amber-600 dark:text-amber-400 mb-2">
            FA System
          </div>
          <div className="flex items-end justify-between gap-4">
            <div>
              <h1 className="text-6xl font-bold italic text-slate-900 dark:text-slate-100 leading-none tracking-tight">
                Student List
              </h1>
          ...
          <hr className="border-0 border-t border-amber-200 dark:border-amber-700 mt-6" />
        </div>
        ...
        <div className="bg-white rounded-xl border border-slate-200 shadow-sm p-4 mb-4 dark:bg-slate-900 dark:border-slate-800">
          <div className="flex flex-wrap items-end gap-3">
            ...
            {/* FA Progress */}
            <div className="w-40">
              <label className="block text-xs font-medium text-slate-500 dark:text-slate-400 mb-1">FA progress</label>
              <select
