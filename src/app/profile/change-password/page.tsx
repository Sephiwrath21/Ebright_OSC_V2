      ...
      <div className="min-h-full bg-slate-50 dark:bg-slate-950">
        <div className="max-w-xl mx-auto px-6 pt-4 pb-10">
          <nav aria-label="Breadcrumb" className="flex items-center gap-2 text-sm text-slate-500 dark:text-slate-400 mb-6">
            ...
            <ChevronRight className="w-4 h-4 text-slate-400" aria-hidden="true" />
            <span className="text-slate-900 dark:text-slate-100 font-medium">Change Password</span>
          </nav>

          <header className="mb-6">
            <h1 className="text-2xl md:text-3xl font-semibold text-slate-900 dark:text-slate-100 tracking-tight">Change Password</h1>
            <p className="mt-1 text-sm text-slate-500 dark:text-slate-400">Enter your current password, then choose a new one.</p>
          </header>
          ...
          <section className="bg-white dark:bg-slate-900 rounded-xl border border-slate-200 dark:border-slate-800 shadow-sm">
            <header className="flex items-start gap-3 px-6 py-5 border-b border-slate-100 dark:border-slate-800">
              ...
              <div>
                <h2 className="text-base font-semibold text-slate-900 dark:text-slate-100">New Password</h2>
                <p className="text-sm text-slate-500 dark:text-slate-400">Choose a password you don&apos;t use elsewhere.</p>
              </div>
            </header>
            <ChangePasswordForm />
          </section>
