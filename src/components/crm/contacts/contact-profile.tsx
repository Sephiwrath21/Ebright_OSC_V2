      ...
      <div className="rounded-xl border border-slate-200 dark:border-slate-800 bg-white dark:bg-slate-900 p-6 shadow-sm">
        <div className="flex items-start gap-4 flex-wrap">
          ...
          <div className="flex items-center gap-2 flex-wrap">
            {/* Jump straight to this lead's opportunity (pipeline) detail — the
                reliable way to reach a lead that's hard to spot on the board. */}
            {primaryOpp && (
              <Button size="sm" asChild>
                <Link href={`/crm/opportunities/${primaryOpp.id}`}>
                ...
                >
                  <div className="mb-2 flex justify-end">
                    <Link
                      ...
                      className="inline-flex items-center gap-1 rounded-md px-2 py-0.5 text-xs font-medium text-indigo-600 hover:bg-indigo-50"
                    >
                      Open opportunity <ArrowRight className="h-3 w-3" />
                    </Link>
                  </div>
                  <div className="flex items-start justify-between gap-2">
                    <div>
