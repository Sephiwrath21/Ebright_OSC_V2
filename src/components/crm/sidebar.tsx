...
const LEAD_NAV_ITEMS: NavItemDef[] = [
  ...
  // Conversations — unified WhatsApp inbox across every lead in the viewer's
  // branches. Visible to all roles: branch staff are the ones actually
  // replying to parents.
  { href: '/crm/conversations', label: 'Conversations',    icon: MessageCircle },
