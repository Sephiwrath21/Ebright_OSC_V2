...
export function IntegrationsPageClient() {
  ...
  return (
    <div className="space-y-6">
      ...
      <div className="grid grid-cols-1 gap-4 sm:grid-cols-2 lg:grid-cols-3">
        {/* WhatsApp is self-service (branch supplies its own credentials), so it
            manages its own state rather than going through IntegrationCard. */}
        <WhatsAppIntegrationCard readOnly={readOnly} />
