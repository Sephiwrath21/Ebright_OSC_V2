...
export interface SessionUser {
  ...
  tktBranchIds?: string[]
  /**
   * For a SCOPED department account (finance, hr, academy, marketing,
   * operation): the ticket sub_type it triages. Drives the ticket-module
   * topbar lock — a scoped department sees only its own chip on ticket pages,
   * while its lead-module topbar (marketing/operation) is left untouched.
   * Null for the owner (od@), agency-view (ceo), and everyone else.
   */
  departmentSubType?: string | null
  /** Display name for the scoped department (e.g. "Finance"). */
